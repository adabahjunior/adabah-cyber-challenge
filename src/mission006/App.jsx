...
import { MISSION_006 } from "../mission/missions/mission006";
import IncidentDashboard from "./components/IncidentDashboard";
import ServerStatusBoard from "./components/ServerStatusBoard";
...
const STORAGE_KEY = "acc_mission_006_v1";
...
export default function App() {
  ...
  useEffect(() => {
    try {
      ...
      setMissionStatus(
        saved.missionStatus ||
          (saved.completed ? "BREACH CONFIRMED" : saved.started ? "RESPONDING" : "STANDBY")
      );
    } catch (_) {}
  }, []);
  ...
  function completeMission(verifiedMap = verified) {
    ...
    setCompleted(true);
    setMissionStatus("BREACH CONFIRMED");
      ...
      {showCompleteAnim ? (
        <div className="complete-overlay blackout">
          <div className="complete-burst">
            ...
            <h2>STATUS · INITIAL BREACH CONFIRMED</h2>
            <p className="mono">OPERATION BLACKOUT — PART I</p>
            <p className="continued">TO BE CONTINUED…</p>
          </div>
        </div>
      ) : null}

      <div className="mission-app mission-002 mission-006">
        ...
        <section className="glass section priority-alert" style={{ padding: "1.25rem 1.3rem", marginTop: "1rem" }}>
          ...
          <p className="mono dim" style={{ marginBottom: "0.75rem", fontSize: "0.82rem" }}>
            {mission.subtitle} · Classification CONFIDENTIAL · 07:42 GMT
          </p>
          ...
          {!started ? (
            <p className="mono dim" style={{ marginTop: "0.75rem", fontSize: "0.82rem" }}>
              Click ENTER INCIDENT RESPONSE ROOM to join the ADABAH Cyber Response Team.
            </p>
          ) : (
        ...
        <div className="m2-layout">
          <div className="m2-main stack">
            <section className="section">
              <div className="row" style={{ justifyContent: "space-between", marginBottom: "0.85rem" }}>
                <div>
                  <p className="eyebrow">Incident Response Room</p>
                  <h2 style={{ fontSize: "1.15rem" }}>Cyber Operations Center</h2>
                </div>
              ...
              {started && activeEv ? (
                <div className="glass evidence-stage" style={{ marginTop: "1rem", padding: "1.1rem" }}>
                  ...
                  {activeEv.type === "dashboard" && <IncidentDashboard />}
                  {activeEv.type === "servers" && <ServerStatusBoard />}
                  {activeEv.type === "logs" && <SystemLogViewer />}
                  {activeEv.type === "email" && <EmergencyEmail />}
                  {activeEv.type === "timeline" && <TimelineBoard />}
                </div>
              ) : null}
            </section>
            ...
            {completed && completionMeta ? (
              <section className="glass" style={{ padding: "1.25rem 1.3rem" }}>
                ...
                <p className="mono" style={{ color: "var(--red-bright)", marginTop: "0.35rem" }}>
                  STATUS · Initial Breach Confirmed
                </p>
                ...
                <div className="continued-card">
                  ...
                  <p className="muted">
                    Operation Blackout has only begun. The attacker is still active. Mission 007 will resume the
                    investigation.
                  </p>
                </div>
              </section>
          ...
          <div className="toolkit-wrap">
            <div className="glass panel status-chip">
              ...
              <div className="mono dim" style={{ fontSize: "0.68rem", marginTop: "0.55rem" }}>
                INCIDENT PROGRESS
              </div>
